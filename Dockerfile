...
# Native deps needed to compile sqlite3 and canvas
...
# Native deps for sqlite3 and canvas runtime
RUN apk add --no-cache python3 make g++ pkgconfig cairo-dev pango-dev jpeg-dev giflib-dev librsvg-dev
...
RUN apk del python3 make g++ pkgconfig cairo-dev pango-dev jpeg-dev giflib-dev librsvg-dev \
